...
final class FirebirdDriverTest extends AbstractTestCase
{
    private const string DSN = 'sqlite::memory:';

    private FirebirdDriver $driver;
    ...
    protected function setUp(): void
    {
        ...
        $this->driver = new FirebirdDriver($this->eventDispatcher);
    }
    ...
    public function testConnectThrowsExceptionForInvalidDSN(): void
    {
        ...
        $this->expectExceptionMessage('Could not connect to the Firebird database');
    ...
    public function testExecuteWithCustomDataTransformer(): void
    {
        ...
        $driver = new FirebirdDriver($this->eventDispatcher, $dataTransformer);
    ...
    public function testExecuteWithCustomQueryNormalizer(): void
    {
        ...
        $driver = new FirebirdDriver($this->eventDispatcher, null, $queryNormalizer);
    ...
    public function testExecuteWithBooleanParameters(): void
    {
        ...
        self::assertSame(['id' => 1, 'active' => 1, 'deleted' => 0], $result->fetch());
    }
